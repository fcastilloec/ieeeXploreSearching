...
* **excel:** add styling and convert json-files to xls ([54c64c4](https://github.com/fcastilloec/ieeexplore2csv/commit/54c64c4987766c0e5cdda7e945ac59a7314f0ccb))
* **logic:** use standarize json for logic operators ([7bb744e](https://github.com/fcastilloec/ieeexplore2csv/commit/7bb744e3d1649782e85f03547cda8325512f6770))
* **search:** use new standarize results when searching ([eb1a26d](https://github.com/fcastilloec/ieeexplore2csv/commit/eb1a26d399632a15e986d6a75905715b606d8cbf))
...
* standarize how results are saved for both API and Scrap searching ([7017e3a](https://github.com/fcastilloec/ieeexplore2csv/commit/7017e3a5e28a7a3a82949e1857aa0221059fb4d8))
...
* **search:** exit if unknow errors are thrown when searching ([d333929](https://github.com/fcastilloec/ieeexplore2csv/commit/d333929601df6a126e40ae8ae5c9194141e1bca8))
